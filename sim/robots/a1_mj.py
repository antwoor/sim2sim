...
from motion_imitation.robots import a1_original as a1
XML_PATH = os.path.join(parentdir , "sim/robots/a1/scene.xml")
_UNIT_QUATERNION = (1, 0, 0, 0)
ABDUCTION_D_GAIN = a1.ABDUCTION_D_GAIN
class custom_pyb():
...
class A1_mj(a1.A1):
    def __init__(
      ...
      xml_path = XML_PATH,
        ...
        super(A1_mj, self).__init__(pybullet_client=a1.pyb, 
                                    reset_time=-1,
